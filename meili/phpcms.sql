...
MySQL - 5.0.45-community-nt-log : Database - phpcms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`phpcms` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `v9_admin`(`userid`,`username`,`password`,`roleid`,`encrypt`,`lastloginip`,`lastlogintime`,`email`,`realname`,`card`,`lang`) values (1,'phpcms','324aad678a6db99c1f6be9bcb6f138f9',1,'eDw96D','192.168.1.230',1351563673,'474638401@qq.com','','','');
...
insert  into `v9_link`(`linkid`,`siteid`,`typeid`,`linktype`,`name`,`url`,`logo`,`introduce`,`username`,`listorder`,`elite`,`passed`,`addtime`) values (1,1,0,1,'PHPCMS','http://www.phpcms.cn','http://www.phpcms.cn/images/logo_88_31.gif','','',0,0,1,1351563556),(2,1,0,1,'网站云','http://web.grandcloud.cn','http://web.grandcloud.cn/statics/images/logo_webcloudgrand.gif','','',0,0,1,1351563556);
...
/*Data for the table `v9_poster_201210` */
...
insert  into `v9_session`(`sessionid`,`userid`,`ip`,`lastvisit`,`roleid`,`groupid`,`m`,`c`,`a`,`data`) values ('ab7fe79907855f64dc5e60c0c1be309b',1,'192.168.1.230',1351563639,1,0,'','','','code|s:4:\"lfgz\";userid|s:1:\"1\";roleid|s:1:\"1\";pc_hash|s:6:\"KGAMSR\";lock_screen|i:0;'),('14ab4653c9eb28a6161607339972ee68',1,'192.168.1.230',1351563674,1,0,'admin','index','public_menu_left','code|s:4:\"34b9\";userid|s:1:\"1\";roleid|s:1:\"1\";pc_hash|s:6:\"MdicKt\";lock_screen|i:0;');
...
insert  into `v9_site`(`siteid`,`name`,`dirname`,`domain`,`site_title`,`keywords`,`description`,`release_point`,`default_style`,`template`,`setting`,`uuid`) values (1,'默认站点','','http://192.168.1.230/v9_v9/install_package/','PHPCMS演示站','PHPCMS演示站','PHPCMS演示站','','default','default','array (\n  \'upload_maxsize\' => \'2048\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf\',\n  \'watermark_enable\' => \'1\',\n  \'watermark_minwidth\' => \'300\',\n  \'watermark_minheight\' => \'300\',\n  \'watermark_img\' => \'/statics/images/water/mark.png\',\n  \'watermark_pct\' => \'85\',\n  \'watermark_quality\' => \'80\',\n  \'watermark_pos\' => \'9\',\n)','744877b3-7388-1030-83e1-ae4e7a7af55f');
...
insert  into `v9_sso_admin`(`id`,`username`,`password`,`encrypt`,`issuper`,`lastlogin`,`ip`) values (1,'phpcms','9f4c2420a33b1de6823ad36a8a7c9dde','iEzl3T',1,0,'');
...
insert  into `v9_sso_applications`(`appid`,`type`,`name`,`url`,`authkey`,`ip`,`apifilename`,`charset`,`synlogin`) values (1,'phpcms_v9','phpcms v9','http://192.168.1.230/phpcms_v9/install_package/','ZgwyhTMHCexLGHu6Lyr9alY2RMo9nSDg','','api.php?op=phpsso','utf-8',1);
